...
INSERT INTO "new_contracts" ("contractNumber", "createdAt", "depositAmount", "endDate", "id", "notes", "paymentFrequency", "rentAmount", "startDate", "status", "tenantId", "unitId", "updatedAt") SELECT "contractNumber", "createdAt", "depositAmount", "endDate", "id", "notes", "paymentFrequency", "rentAmount", "startDate", "status", "tenantId", "unitId", "updatedAt" FROM "contracts";
