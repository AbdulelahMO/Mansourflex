...
CREATE TABLE "new_contracts" (
    ...
    "depositAmount" REAL,
    "depositApplied" REAL NOT NULL DEFAULT 0,
...
INSERT INTO "new_contracts" ("amountType", "contractNumber", "createdAt", "createdById", "depositAmount", "ejarContractNumber", "endDate", "id", "increasePercent", "notes", "paymentFrequency", "renewedFromId", "rentAmount", "startDate", "status", "tenantId", "unitId", "updatedAt", "vatRate") SELECT "amountType", "contractNumber", "createdAt", "createdById", "depositAmount", "ejarContractNumber", "endDate", "id", "increasePercent", "notes", "paymentFrequency", "renewedFromId", "rentAmount", "startDate", "status", "tenantId", "unitId", "updatedAt", "vatRate" FROM "contracts";
